...
const PriseListItems = () => {
	return (
		<div className='size-full pt-10 pb-20 px-5 md:px-20 mx-auto flex items-center justify-center'>
			<div className='w-full mx-auto flex flex-col items-center justify-center gap-y-10 border-2 rounded-md px-2.5 py-5'>
				...
				<ul className='grid lg:grid-cols-2 lg:px-10 gap-2 '>
