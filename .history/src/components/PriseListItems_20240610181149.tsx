...
const PriseListItems = () => {
	return (
		<div className='size-full py-10 px-5 md:px-20 mx-auto flex items-center justify-center'>
			<div className='w-full mx-auto flex flex-col items-center justify-center'>
				...
				<ul className='grid md:grid-cols-2 gap-2 py-4 place-content-center'>
					{dummyData.map(({ id, text }) => (
						<li key={`item-${id}`} className='flex items-center justify-start gap-x-4'>
