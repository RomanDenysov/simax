	...
	return (
		<center className="relative w-full min-h-fit h-full flex flex-col items-center justify-center">
			<div className="relative mx-auto top-0 left-0 w-full ">
				...
				/>
				<div className="relative max-w-screen-xl max-h-screen h-screen w-full text-white text-center flex flex-col items-center md:items-center justify-center gap-y-10 md:gap-y-20 px-5 px-20">
