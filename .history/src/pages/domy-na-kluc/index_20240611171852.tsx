...
const dummyData2 = [
	{ id: 1, text: 'obvodový zateplovací systém polystyrén hr. 150 mm' },
	{ id: 2, text: 'omietky vnútorné' },
	{ id: 3, text: 'omietky vonkajšie silikátové BAUMIT hr. 1,5 mm + mozaikové' },
	{ id: 4, text: 'striekaná izolácia stropu 300 mm' },
	{ id: 5, text: 'podhľady vnútorné – sádrokartón' },
	{ id: 6, text: 'izolácie podláh – podlahový polystyrén 10 cm' },
	{ id: 7, text: 'hygienický náter interiérových stien a stropov aplikovaný 2x' },
	{ id: 8, text: 'pokládka podlahy' },
	{ id: 9, text: 'keramické podlahy vnútorné' },
	{ id: 10, text: 'keramické obklady do kúpeľne a WC' },
	{
		id: 11,
		text: 'zariaďovacie predmety (WC, umývadlá, vaňa alebo sprchovací kút, batérie)',
	},
	{ id: 12, text: 'interiérové dvere – dýha štandard + obložkové zárubne' },
	{ id: 13, text: 'doprava a presun hmôt + prenájom techniky' },
	{
		id: 14,
